  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 to-slate-800 py-8">
      ...
      <div
        className="relative"
        style={{
          width: 2 * CIRCLE_RADIUS + 200,
          height: 2 * CIRCLE_RADIUS + 200,
        }}
      >
        {/* Center Avatar or Logo */}
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
          <div className="w-36 h-36 flex items-center justify-center animate-bounce rounded-full bg-gradient-to-br from-indigo-600 to-purple-600 shadow-lg text-white text-6xl font-bold border-4 border-white">
            💻
          </div>
        </div>
        {/* Skills around the circle */}
        {skills.map((skill, idx) => {
          ...
          return (
            ...
            >
              <div
                className={`w-32 h-32 flex flex-col items-center justify-center rounded-xl shadow-xl ${skill.color} text-white text-center transition-all duration-300 hover:scale-110 hover:rotate-6`}
                style={{
